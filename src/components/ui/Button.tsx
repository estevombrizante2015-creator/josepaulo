...
const variantClasses: Record<Variant, string> = {
  primary:
    "isolate h-13 overflow-hidden bg-fg px-7 text-canvas before:absolute before:inset-0 before:-z-10 before:origin-left before:scale-x-0 before:bg-gold before:transition-transform before:duration-500 before:ease-editorial hover:text-ink hover:before:scale-x-100 focus-visible:text-ink focus-visible:before:scale-x-100",
  outline:
    "h-13 border border-fg/25 px-7 text-fg hover:border-accent hover:text-accent focus-visible:border-accent",
